...
void Interpreter::execute(Instruction::div1_t i) { val1(i.d) = val1(i.a) / val1(i.b); }
...
void Interpreter::execute(Instruction::div2_t i) { val2(i.d) = val2(i.a) / val2(i.b); }
...
void Interpreter::execute(Instruction::div4_t i) { val4(i.d) = val4(i.a) / val4(i.b); }
...
void Interpreter::execute(Instruction::div8_t i) { val8(i.d) = val8(i.a) / val8(i.b); }
